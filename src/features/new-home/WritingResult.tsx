...
const WritingResult = () => {
  ...
  const { writingEvaluation } = useStore();
  ...
  useEffect(() => {
    ...
    if (!writingEvaluation.scores) {
      navigate("/NewHome");
      return;
    }
    setIsLoading(false);
  }, [writingEvaluation, navigate]);
  ...
  const { scores, feedback, submission } = writingEvaluation as any;
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-8">
              ...
              <div className="space-y-4">
                ...
                {[
                  ["Clarity & Organization", scores.clarity],
                  ["Grammar & Vocabulary", scores.grammar],
                  ["Professional Tone", scores.tone],
                  ["Content Relevance", scores.content],
                ].map(([label, val]) => (
                  ...
                  <div className="prose max-w-none">
                    <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                      <p className="text-blue-800 text-sm">
                        <strong>Evaluation Summary:</strong> Your writing has
