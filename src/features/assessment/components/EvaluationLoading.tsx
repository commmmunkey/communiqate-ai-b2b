...
const EvaluationLoading = () => {
  ...
  return (
    <Dialog open={evaluationLoading.isVisible} onOpenChange={() => {}}>
      <DialogContent
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            {evaluationLoading.message || "Analyzing your response"}
            {dots}
          </p>
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-between text-sm text-gray-500 mt-2">
              ...
              <span>
                {formatTime(evaluationLoading.estimatedTime)} remaining
              </span>
            </div>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="text-left">
                ...
                <ul className="text-xs text-blue-600 space-y-1">
                  ...
                  <li>
                    • The AI analyzes clarity, grammar, and professional tone
                  </li>
