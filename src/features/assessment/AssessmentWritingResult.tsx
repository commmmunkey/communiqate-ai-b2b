...
const AssessmentWritingResult = () => {
  ...
  const calculateScoresAfterWriting = () => {
    try {
      ...
      localStorage.setItem(
        "ASSESSMENT_WRITING_SCORE",
        (writingScores?.overall || 0).toString(),
      );
    } catch (error) {
      ...
      <div className="flex items-center justify-center h-screen bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            No assessment writing results found.
          </p>
          <button
            onClick={() => navigate(-1)}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span
                      className={`text-sm font-semibold ${getScoreColor(scores.clarity)}`}
                    >
                      {scores.clarity}/10
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span
                      className={`text-sm font-semibold ${getScoreColor(scores.grammar)}`}
                    >
                      {scores.grammar}/10
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span
                      className={`text-sm font-semibold ${getScoreColor(scores.tone)}`}
                    >
                      {scores.tone}/10
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span
                      className={`text-sm font-semibold ${getScoreColor(scores.content)}`}
                    >
                      {scores.content}/10
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-blue-700">
                      This assessment evaluates your professional writing skills
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0 w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                    <p className="text-blue-700">
                      Focus on clarity, professionalism, and relevance to the
                      given prompt.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0 w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                    <p className="text-blue-700">
                      Practice regularly to improve your writing skills and
