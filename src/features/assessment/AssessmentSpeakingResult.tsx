...
const AssessmentSpeakingResult = () => {
    ...
    const calculateAllScores = () => {
        try {
            ...
            localStorage.setItem('ASSESSMENT_SPEAKING_SCORE', (speakingScores?.overall || 0).toString());
        ...
        return (
            <div className="flex items-center justify-center h-screen bg-gray-100">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">No assessment speaking results found.</p>
                    <button 
                        onClick={() => navigate(-1)}
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        {calculatedScores && (
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                                <div className="text-center">
                                    <div className={`text-2xl font-bold ${getScoreColor(calculatedScores.assessment_readingScore || 0)}`}>
                                        {calculatedScores.assessment_readingScore || 0}/10
                                    </div>
                                    <div className="text-sm text-gray-600">Reading</div>
                                </div>
                                <div className="text-center">
                                    <div className={`text-2xl font-bold ${getScoreColor(calculatedScores.assessment_listeningScore || 0)}`}>
                                        {calculatedScores.assessment_listeningScore || 0}/10
                                    </div>
                                    <div className="text-sm text-gray-600">Listening</div>
                                </div>
                                <div className="text-center">
                                    <div className={`text-2xl font-bold ${getScoreColor(calculatedScores.assessment_generalScore || 0)}`}>
                                        {calculatedScores.assessment_generalScore || 0}/10
                                    </div>
                                    <div className="text-sm text-gray-600">General</div>
                                </div>
                                <div className="text-center">
                                    <div className={`text-2xl font-bold ${getScoreColor(calculatedScores.assessment_writingScore || 0)}`}>
                                        {calculatedScores.assessment_writingScore || 0}/10
                                    </div>
                                    <div className="text-sm text-gray-600">Writing</div>
                                </div>
                                <div className="text-center">
                                    <div className={`text-2xl font-bold ${getScoreColor(calculatedScores.assessment_speakingScore || 0)}`}>
                    ...
                    {submission?.transcription && (
                        <div className="bg-white rounded-lg shadow-md p-6">
                            <h3 className="text-lg font-semibold mb-4">Your Speech Transcription</h3>
